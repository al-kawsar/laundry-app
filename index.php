              ...
              <div class="flex items-center justify-between space-x-2">
                ...
                <div class="flex space-x-2">
                  <div class="relative cursor-pointer">
                    <button class="btn size-7 bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
